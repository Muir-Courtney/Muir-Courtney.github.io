...
request.onload = function () {
    ...
    templeLosAngeles(templeData);
}

function templeLosAngeles(jsonObj) {
...
let apiURLstring = 'https://api.openweathermap.org/data/2.5/weather?id=5368361&units=imperial&APPID=14dbf81157245dbf8ed927ab0d4c2f49';
