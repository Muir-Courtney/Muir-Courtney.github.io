...
request.onload = function () {
    ...
    templeManhattan(templeData);
}

function templeManhattan(jsonObj) {
...
let apiURLstring = 'https://api.openweathermap.org/data/2.5/weather?id=5125771&units=imperial&APPID=14dbf81157245dbf8ed927ab0d4c2f49';
